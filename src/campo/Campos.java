...
public class Campos {
   ...
   //Acá se incluye toda la logica necesaria para agregar cartas al campo de batalla de cada jugador
    ...
    public void agregarCartas (Carta carta){
        try {
            switch (carta.getClass().toString()) {
                ...
                //Acá habria que hacer que se arroje la magia, ya que no queda fija en el campo.
                //Ej: Lanzar hechizo
                    campoMonstruos.agregarCarta(carta);
                    break;
                default:
